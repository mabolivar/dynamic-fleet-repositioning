...
::: {.column-margin}
It is possible to extend this model to also account for the assignment process and include a  *Resource transition function* and a *Demand transition function*.
:::
